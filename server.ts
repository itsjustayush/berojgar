...
async function startServer() {
  ...
  httpServer.listen(PORT, '0.0.0.0', () => console.log(`[Berozgar] Server listening on http://0.0.0.0:${PORT}`));
}

startServer().catch((err) => console.error('[Berozgar] Server error:', err));
